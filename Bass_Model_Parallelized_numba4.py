...
def main(market_size_filename, bass_input_name):
    ...
    for zone in bass_input['ZoneID'].unique():
        ...
        y = df_zone.loc[(df_zone['months_passed_01_2021'] > 0)|(df_zone['2021-2024'] > 0), '2021-2024'].values.astype(np.float64)
    ...
    out_file = f'best_parameter_{market_size_filename}.csv'
